...
const Category = () => {
  return (
    <section className=" pb-[5rem]"> 
     <h5 className="mb-5 text-[30px] md:text-[40px] text-center
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-7">
        ...
        <div className="w-[420px] h-[550px] group-hover:scale-110 transition-all duration-500">
        <div className="absolute">
      <Image src={'/continental.png'}
       alt=""
       width={400}
       height={300} 
       className="object-cover w-[420px] h-[550px]"
      />
      </div>
      <div className="relative w-[420px] h-[550px] bg-black/25 
      flex justify-center items-end group-hover:-translate-y-6 
    ...
    hover:bg-white hover:text-black">SHOP COLLECTION</button>
        ...
        <div className="group overflow-hidden flex justify-center items-center">
        <div className="w-[400px] h-[600px] group-hover:scale-110 transition-all duration-500">
        <div className="absolute">
